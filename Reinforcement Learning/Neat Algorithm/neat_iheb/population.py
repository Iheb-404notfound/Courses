...
from neat_iheb.species import Species
...
class Population:
    ...
    def update_top(self):
        self.top = max(max([species.top() for species in self.species], key=lambda x: x.fitness), self.top, key=lambda x: x.fitness)
    ...
    def evolve(self):
        ...
        for species in self.species:
            ...
            self.global_fitness += species.global_fitness
